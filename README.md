...
- 공공데이터 연계: 화성시 공영주차장 공개 CSV 기반 주차 인프라 현황 표시
...
- 연계 데이터: 경기도 화성시_공영주차장 정보_20251117
- 제공기관: 경기도 화성시
- 활용 목적: 주차 혼잡·불법주차 반복 민원 발생 시 공영주차장 위치, 면수, 권역별 분포를 함께 확인
- 앱 표시 항목: 공영주차장 구간 수, 총 주차면수, 장애인 주차면수, 권역별 면수, 위치 지도, 데이터 미리보기
